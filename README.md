...
```
git remote set-url origin https://github.com/marian-craciunescu/msgraphbeat
...
```
mkdir -p ${GOPATH}/src/github.com/marian-craciunescu/msgraphbeat
git clone https://github.com/marian-craciunescu/msgraphbeat ${GOPATH}/src/github.com/marian-craciunescu/msgraphbeat
```
